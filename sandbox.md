...
Daiver, [18.09.2022, 11:29]
2) авторизацию оставляем сейчас как есть, но делаем опициональным еще один вид авторизации.
Логин - номер телефона
Когда человек входит первый раз, нажимает на форме авторизации на кнопку: получить одноразовый смс код. Идет дозвон и он вводит последние 4 цифры номера, которые ему пришли
При каждом заходе в лк после этого будет ообщение: установите постоянный пароль. Там форма, содержащая Имя, пароль и подтверждение пароля
Вход по временному паролю всегда сохраняется у пользователя

Daiver, [18.09.2022, 11:30]
в лк будет история заказов. сохраненные адреса и возможность управления ими(добавит, удалить, сделать дефолтным)
история сохраненных корзин(из функции 1, которую я описывал)
